<x-admin::layouts.anonymous>
    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-6">
        <div class="flex flex-col items-center gap-5">
            <!-- Company Logo -->
            @if ($logo = (core()->getConfigData('general.general.admin_logo.logo_image') ?? core()->getConfigData('general.design.admin_logo.logo_image')))
                <img
            ...
            <div class="box-shadow flex min-w-[320px] flex-col rounded-md bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-lg">
                ...
                <x-admin::form :action="route('admin.session.store')">
                    ...
                    <div class="border-y p-4 dark:border-gray-800">
                        ...
                        <x-admin::form.control-group class="relative w-full">
                            ...
                            <x-admin::form.control-group.control
                                type="password"
                                class="w-[270px] max-w-full ltr:pr-10 rtl:pl-10"
                                id="password"
                                name="password"
