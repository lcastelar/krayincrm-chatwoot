# Especificação integrada: Integração automatizada e administrável entre Chatwoot e Krayin

| Campo | Valor |
| --- | --- |
| Formato | Specsfy/2.0 |
| ID | SPEC-0001 |
| Slug | 0001-integracao-chatwoot-krayin-automatizada-e-administravel |
| Status | Draft |
| Effort | 1 |
...
- `specs/draft/0001-integracao-chatwoot-krayin-automatizada-e-administravel/research/[fonte]/`: [origem, versão/data, licença quando aplicável e propósito], ou “Nenhum artefato externo”.
...
```text
specs/draft/0001-integracao-chatwoot-krayin-automatizada-e-administravel/
  spec.md
  research/
src/
tests/
...
- **Resultado**: Pending
- **Comando**: `node .agents/skills/specsfy-04-validate/scripts/validate_spec.mjs specs/draft/0001-integracao-chatwoot-krayin-automatizada-e-administravel/spec.md`
- **Achados**: [Pending.]
...
- **Resultado**: Pending
- **Comando**: `node .agents/skills/specsfy-05-tasks/scripts/validate_tasks.mjs specs/draft/0001-integracao-chatwoot-krayin-automatizada-e-administravel/spec.md`
- **Achados**: [Pending.]

#### Gate do Ato III — Entrega

- **Resultado**: Pending
- **Comando**: `node .agents/skills/specsfy-06-tdd-bdd/scripts/check_traceability.mjs specs/draft/0001-integracao-chatwoot-krayin-automatizada-e-administravel/spec.md .`
- **Achados**: [Pending.]
